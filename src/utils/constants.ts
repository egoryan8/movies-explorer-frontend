...
export const FIRST_SEARCH_MESSAGE = 'Введите запрос и добавьте понравившиеся фильмы';
export const NOT_FOUND_MESSAGE = 'По вашему запросу ничего не найдено';
export const NO_SAVED_FILMS_MESSAGE = 'Сейчас у вас нет сохраненных фильмов. Добавьте понравившиеся через форму поиска на странице "фильмы"'
